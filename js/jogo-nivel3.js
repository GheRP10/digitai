document.addEventListener('DOMContentLoaded', () => {
    ...
    // ======================================================
    let estadoJogo = {};
    const totalPalavrasNivel3 = palavrasNivel3.length;
    const progressoChave = 'progressoNivel3';
    const nivelAtual = 3;
    ...
    function iniciarJogo() {
        ...
        progressoNivelSpan.textContent = `${progresso.acertos} / ${totalPalavrasNivel3}`;
    ...
    function mostrarCardProximoNivel() {
        ...
        cardContainer.innerHTML = `
            <div class="card text-center">
                ...
                <div class="card-body">
                    <h3 class="card-title">Nível 3 Concluído!</h3>
                    <p class="card-text">Você foi incrível! Que tal um novo desafio?</p>
                    <hr>
                    <h5 class="card-title">Próximo: Nível 4 - Ditados</h5>
                    <p class="card-text">Teste sua precisão com frases e ditados.</p>
                    <a href="nivel4.html" id="btn-proximo-nivel" class="btn btn-success btn-lg">Vamos lá!</a>
                </div>
            </div>
        `;
    ...
    function apresentarNovaPalavra() {
        ...
        if (indiceAtual >= totalPalavrasNivel3) {
            palavraDisplay.textContent = "Nível 3 COMPLETO!";
        ...
        const palavraAtual = palavrasNivel3[indiceAtual];
    ...
    inputPalavra.addEventListener('input', () => {
        ...
        const palavraAtual = palavrasNivel3[estadoJogo[progressoChave].indice];
