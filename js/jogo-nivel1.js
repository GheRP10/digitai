document.addEventListener('DOMContentLoaded', () => {
    ...
    // ======================================================
    let estadoJogo = {};
    const totalPalavrasNivel1 = palavrasNivel1.length;
    const progressoChave = 'progressoNivel1';
    const nivelAtual = 1;
    ...
    function iniciarJogo() {
        ...
        progressoNivelSpan.textContent = `${progresso.acertos} / ${totalPalavrasNivel1}`;
    ...
    function mostrarCardProximoNivel() {
        ...
        cardContainer.innerHTML = `
            <div class="card text-center">
                ...
                <div class="card-body">
                    <h3 class="card-title">Nível 1 Concluído!</h3>
                    <p class="card-text">Você foi incrível! Que tal um novo desafio?</p>
                    <hr>
                    <h5 class="card-title">Próximo: Nível 2 - Diferentes formatos</h5>
                    <p class="card-text">Treine o uso das teclas Shift e Caps Lock.</p>
                    <a href="nivel2.html" id="btn-proximo-nivel" class="btn btn-success btn-lg">Vamos lá!</a>
                </div>
            </div>
        `;
    ...
    function apresentarNovaPalavra() {
        ...
        if (indiceAtual >= totalPalavrasNivel1) {
            palavraDisplay.textContent = "NÍVEL 1 COMPLETO!";
        ...
        const palavraAtual = palavrasNivel1[indiceAtual];
    ...
    inputPalavra.addEventListener('input', () => {
        ...
        const palavraAtual = palavrasNivel1[estadoJogo[progressoChave].indice];
