document.addEventListener('DOMContentLoaded', () => {
    ...
    // ======================================================
    let estadoJogo = {};
    const totalPalavrasNivel4 = palavrasNivel4.length;
    const progressoChave = 'progressoNivel4';
    const nivelAtual = 4;
    ...
    function mostrarCardProximoNivel() {
        ...
        cardContainer.innerHTML = `
            <div class="card text-center">
                ...
                <div class="card-body">
                    <h3 class="card-title">Nível 4 Concluído!</h3>
                    <p class="card-text">Você foi incrível! Que tal um novo desafio?</p>
                    <hr>
                   <h5 class="card-title">Próximo: Nível 5 - Números</h5>
                    <p class="card-text">Trabalhe o uso dos números e operações básicas.</p>
                    <a href="nivel5.html" id="btn-proximo-nivel" class="btn btn-success btn-lg">Vamos lá!</a>
                </div>
            </div>
        `;
    ...
    function apresentarNovaPalavra() {
        ...
        if (indiceAtual >= totalPalavrasNivel4) {
            palavraDisplay.textContent = "Nível 4 COMPLETO!";
        ...
        const palavraAtual = palavrasNivel4[indiceAtual];
